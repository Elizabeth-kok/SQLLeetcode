...
-- Write a query to find the overall acceptance rate of requests rounded to
-- 2 decimals, which is the number of acceptance divide the number of requests.
...
-- and a request could be accepted more than once. In this case, the ‘duplicated’
